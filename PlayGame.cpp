...
void PLAYGAME:: swap ( piece p1 , piece p2 ){
...
//
//}
void PLAYGAME:: ClickValidate ( sf::RenderWindow &window ){
...
void PLAYGAME::SCOREINCREMENT(){

    ScoreINT=stoi(ScoreCount);
    ScoreINT+=50;
    ScoreCount= std::to_string(ScoreINT);
}
void PLAYGAME::Score(sf::RenderWindow &window){
//    sf::Text SCORE;
    SCORE.setFont(font);
...
void PLAYGAME::Moves(sf::RenderWindow &window){
...
PLAYGAME::PlayGameResult PLAYGAME::draw(sf::RenderWindow& window){
