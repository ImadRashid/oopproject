...
void PLAYGAMEHARD:: swap ( piece p1 , piece p2 ){
...
//
//}
void PLAYGAMEHARD:: ClickValidate ( sf::RenderWindow &window ){
...
void PLAYGAMEHARD::SCOREINCREMENT(){

    ScoreINT=stoi(ScoreCount);
    ScoreINT+=50;
    ScoreCount= std::to_string(ScoreINT);
}
void PLAYGAMEHARD::Score(sf::RenderWindow &window){
//    sf::Text SCORE;
    SCORE.setFont(font);
...
void PLAYGAMEHARD::Moves(sf::RenderWindow &window){
...
//PLAYGAMEHARDResult PLAYGAMEHARD::GetGameResponse(sf::RenderWindow &Window){
//
//
//}

PLAYGAMEHARD::PlayGameResult PLAYGAMEHARD::draw(sf::RenderWindow& window){
...
//    c_menu menu(window.getSize().x,window.getSize().y);
    Texture t1,t2;
    t1.loadFromFile("Designs/background3.png");
